/*******************************************************
 @Author: zhezhaoxu
 @Created Time : Wed 27 Sep 2017 01:26:42 PM CST
 @File Name: wire.hpp
 @Description: from libzmq/src/wire.hpp
 ******************************************************/

#ifndef UTILS_ZMQ_WIRE_HPP_
#define UTILS_ZMQ_WIRE_HPP_
...
inline uint8_t get_uint8(const unsigned char *buffer_) { return *buffer_; }
...
inline uint16_t get_uint16(const unsigned char *buffer_) {
	return (uint16_t)((((uint16_t)buffer_[0]) << 8) | ((uint16_t)buffer_[1]));
}
