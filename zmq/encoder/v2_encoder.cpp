/*******************************************************
 @Author: zhezhaoxu
 @Created Time : Wed 27 Sep 2017 02:25:45 PM CST
 @File Name: v2_encoder.cpp
 @Description: from libzmq/src/v2_encoder.cpp
 ******************************************************/
...
utils::v2_encoder_t::v2_encoder_t(size_t bufsize_)
	: encoder_base_t<v2_encoder_t>(bufsize_) {
	//  Write 0 bytes to the batch and go to message_ready state.
	next_step(NULL, 0, &v2_encoder_t::message_ready, true);
}

utils::v2_encoder_t::~v2_encoder_t() {}

void utils::v2_encoder_t::message_ready() {
	//  Encode flags.
	unsigned char &protocol_flags = tmpbuf[0];
	protocol_flags = 0;
	if (in_progress->flags() & msg_t::more)
		protocol_flags |= v2_protocol_t::more_flag;
	if (in_progress->size() > 255) protocol_flags |= v2_protocol_t::large_flag;
...
void utils::v2_encoder_t::size_ready() {
